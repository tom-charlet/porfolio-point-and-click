...
const Software = ({ title, type, position, content }) => {
    ...
    return <button ref={ref} className={`cursor-pointer h-full p-1 grid grid-rows-[1fr_auto] gap-1 place-items-center text-center rounded-[0.2em] hover:bg-grey-800`}>
